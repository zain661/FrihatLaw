...
insert into public.articles (id, title, excerpt, content, author, category, image, date, views, read_time)
values
...
فريق فريحات للمحاماة يرافق عملاءه في جميع مراحل التحكيم، من صياغة الشرط التحكيمي وحتى تمثيلهم أمام هيئة التحكيم ومتابعة التنفيذ.', '{"name":"المحامية أسيل","title":"رئيسة قسم الشركات والخدمات المحلية"}'::jsonb, 'legal', '/brand/office-2.jpg', '2026-07-20', 0, 2),
...
فريق فريحات لخدمات الملكية الفكرية يمتلك شبكة شراكات دولية تُمكّن عملاءنا من تسجيل علاماتهم وحماية حقوقهم في الأسواق التي يستهدفونها بثقة.', '{"name":"المحامية سارة","title":"رئيسة قسم الملكية الفكرية والخدمات الدولية"}'::jsonb, 'ip', '/brand/ip-collage-trademarks.png', '2026-07-10', 0, 2),
...
نظام كيان NHR يرافق المؤسسات في هذا التحول خطوة بخطوة، بدءًا من ترحيل البيانات وحتى التدريب الكامل لفريق الموارد البشرية على النظام الجديد.', '{"name":"فريق كيان NHR","title":"استشارات الموارد البشرية"}'::jsonb, 'hr', '/brand/office-width-1.jpg', '2026-06-28', 0, 2),
...
يلتزم كيان NHR بأعلى معايير حماية البيانات، وبالتوافق التام مع قانون العمل الفلسطيني، ويقدم حلولاً تمتد من إدارة ملفات الموظفين وحتى أتمتة الرواتب والتقارير الإدارية.', '{"name":"فريحات جروب","title":"الإدارة العامة"}'::jsonb, 'news', '/brand/logo-nhr.png', '2026-06-15', 0, 2),
...
فريق فريحات لخدمات الملكية الفكرية يساعد المخترعين والشركات على تقييم ابتكاراتهم واختيار استراتيجية الحماية الأمثل محليًا ودوليًا.', '{"name":"المحامية سارة","title":"رئيسة قسم الملكية الفكرية والخدمات الدولية"}'::jsonb, 'ip', '/brand/ip-collage-patents.png', '2026-05-30', 0, 2),
