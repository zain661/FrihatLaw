...
import { legalPracticeCorporate } from "../data/legalPracticeCorporate";
import { legalPracticeCorporateEn } from "../data/legalPracticeCorporate.en";
...
const COPY = {
  ar: { back: "العودة إلى مجالات الممارسة", arrow: "→", ctaTitle: "تحتاج استشارة في تأسيس شركتك أو متابعة شؤونها القانونية؟", ctaButton: "حجز استشارة" },
  en: { back: "Back to Practice Areas", arrow: "←", ctaTitle: "Need a consultation on incorporating or managing your company's legal affairs?", ctaButton: "Book a Consultation" },
};

export default function LegalPracticeCorporatePage() {
  const { lang } = useLanguage();
  const t = lang === "en" ? legalPracticeCorporateEn : legalPracticeCorporate;
